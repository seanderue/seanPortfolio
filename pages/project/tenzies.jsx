        ...
        <div className={styles.content_container}>
          ...
          <div className={styles.right_column}>
            ...
            <p className={styles.body_text}>This was my first-ever significant project. Originally I wanted to make a table-top multiplayer game, but it didn’t take long to realize I had bit off more than I could chew. Instead, I made the back-end additions necessary to this game that I created at the end of a scrimba-react course. I had really pushed myself on this project, so I remember it fondly.</p>
              ...
              <p className={styles.body_text}>I made a playable game! The back-end is server-validated. So Player A makes an input, the server takes the data, runs it through the game logic, and updates the client-side state of Players A, B, C, and D in the room.
<br/><br/>
I definitely learned how unglamorous backend can be. I put in a lot of work for someone to click a dice and have it turn green on multiple clients. That said, I have the barebones framework complete, and it would be relatively easy to add more features like player power-ups/weapons that they could interact with the enemy board.
<br/><br/>
